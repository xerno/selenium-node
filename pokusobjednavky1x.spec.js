...
describe('pokus-objednavky1', function() {
  ...
  it('pokus-objednavky1', async function() {
    ...
    console.log(vars["x"])
    vars["date"] = await driver.executeScript("var d = new Date(new Date().getTime() + 24 * 60 * 60 * 1000 * (-10)); var m = ((d.getMonth() + 1) < 10) ? \'0\' + (d.getMonth() + 1) : (d.getMonth() + 1); m = d.getDate() + \'.\' + m + \'.\' + d.getFullYear(); return m")
    console.log(vars["date"])
